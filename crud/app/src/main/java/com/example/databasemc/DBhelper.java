...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public boolean delete(String s, String roll) {
        SQLiteDatabase db = this.getReadableDatabase();
        db.execSQL("Delete FROM "+STUDENT_TABLE+" WHERE "+ STUDENT_NAME +"= "+"'"+s+"' "+ " OR "+ STUDENT_ROLL+" = "+"'"+roll+"'");
        return true;
    }
    public boolean find (String roll){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursorCourses = db.rawQuery("Select * FROM "+STUDENT_TABLE+" WHERE "+ STUDENT_ROLL +"= "+"'"+roll+"'",null);
